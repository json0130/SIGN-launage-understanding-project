...
"}")
        ...
        self.data_file_button_3 = QtWidgets.QPushButton(self.test_button_frame, clicked= lambda: self.openWebcam())
        self.data_file_button_3.setMinimumSize(QtCore.QSize(120, 40))
        self.data_file_button_3.setBaseSize(QtCore.QSize(120, 40))
        self.data_file_button_3.setStyleSheet("QPushButton {\n"
"    background-color: #345CC1;\n"
"    color: white; /* Set text color to white for better contrast */\n"
"    border: none;\n"
"    padding: 8px 16px; /* Optional: Add some padding for better appearance */\n"
...
"    background-color: #1E3C8C; /* Optional: Even darker color when pressed */\n"
"}")
        self.data_file_button_3.setObjectName("data_file_button_3")
        self.horizontalLayout.addWidget(self.data_file_button_3)
...
"}")
        ...
        self.data_scroll_2.setStyleSheet("QScrollBar:vertical {\n"
"    background: #333333;\n"
"    width: 15px;\n"
"    margin: 22px 0 22px 0;\n"
"}\n"
...
"}")
        ...
        self.data_scroll_2.setObjectName("data_scroll_2")
        ...
        self.data_image_title_2.setStyleSheet("QLabel {\n"
"    color: white;\n"
"    font-weight: bold;\n"
"}\n"
"")
        self.data_image_title_2.setObjectName("data_image_title_2")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.data_file_button_2.setText(_translate("MainWindow", "Select Dataset"))
        self.data_file_button_3.setText(_translate("MainWindow", "Open Webcam"))
