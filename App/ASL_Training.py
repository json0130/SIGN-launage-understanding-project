...
class Ui_training_session(object):
    # data should include model type, epochs, batch size
    ...
    def setupUi(self, training_session, data):
        ...
        self.view_graph.setGeometry(QtCore.QRect(30, 20, 531, 540))
        
        # Create a figure and canvas
        self.figure = plt.figure()
        self.canvas = FigureCanvas(self.figure)
        self.toolbar = NavigationToolbar(self.canvas, self.view_graph)
